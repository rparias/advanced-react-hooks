...
function PokemonCacheProvider(props) {
  ...
  return <PokemonCacheContext.Provider value={value} {...props}>{props.children}</PokemonCacheContext.Provider>
}

function usePokemonCache() {
  const context = React.useContext(PokemonCacheContext)
  if(!context) {
    throw new Error('The useCount hook must be used within a CountContext.Provider')
  }
  return context
}
